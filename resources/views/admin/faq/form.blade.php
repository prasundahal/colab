                    ...
                    <form action="{{route('faq.update',[$item->id])}}" method="post">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="name" placeholder="Enter Question" name="question" value="{{$item->question}}">
                            </div>
                            <div class="form-group">
                                <label for="answer">Answer</label>
                                <textarea class="form-control" name="answer" id="answer" cols="30" rows="10" placeholder="answer">{{$item->answer}}</textarea>
                            </div>
                        </div>
