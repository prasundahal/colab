...
<head>
    ...
    <meta content="" name="Noor-games">
    <!-- Favicons -->
    <link href="{{ URL::to('frontend/images/logochangecolor.gif') }}" rel="icon">
    <link href="{{ URL::to('frontend/images/logochangecolor.gif') }}" rel="apple-touch-icon">
    <!-- Title Page-->
    ...
    <link href="{{ asset('frontend/css/my.css') }}" rel="stylesheet" media="all">
    ...
    <style>
        * {
         ...
         .modal-backdrop-bg {
         background-image: url({{asset('frontend/images/bgStars.jpg')}});
         }
         .modal-header{
         border:none;
         }
         ...
         background-image:
         linear-gradient(#f11b7e, #b8f11b),
         linear-gradient(#f11b7e, #f11b7e),
         linear-gradient(#f11b7e, #f11b7e),
         linear-gradient(#b8f11b, #b8f11b),
         linear-gradient(#f11b7e, #f11b7e),
         linear-gradient(#b8f11b, #b8f11b),
         linear-gradient(#f11b7e, #f11b7e),
         linear-gradient(#b8f11b, #b8f11b);
...
<body>
    <div class="page-wrapper font-robo">
        <video autoplay muted loop id="myVideo">
            <source src="{{url('frontend/images/fin.mp4')}}" type="video/mp4">
                    ...
                    <div>
                        ...
                        <div class="card-body p-5">
                            <div class="text-center logo form-image-dragon-mobile">
                                <img src="{{ asset('frontend/images/dragonnn.gif') }}" width="220" height="250" class="w-auto">
                            </div>
                                ...
                                <div class="rainbow new-step-wizard">
                                    <div id="smartwizard">
                                        <ul class="nav display-none">
                                            <li>
                                                <a class="nav-link" href="#full_name">
                                                    full Name
                                                </a>
                                            </li>
                                            <li>
                                                <a class="nav-link" href="#first_question">
                                                    first_question
                                                </a>
                                            </li>
                                            <li>
                                                <a class="nav-link" href="#second_question">
                                                    second_question
                                                </a>
                                            </li>
                                            <li>
                                                <a class="nav-link" href="#image1">
                                                    image1
                                                </a>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                <a class="nav-link" href="#image2">
                                                    image2
                                                </a>
                                            </li>
                                            <li>
                                                <a class="nav-link" href="#third_question">
                                                    third_question
                                                </a>
                                            </li>
                                            <li>
                                                <a class="nav-link" href="#fourth_question">
                                                    fourth_question
                                                </a>
                                            </li>
                                            <li>
                                                <a class="nav-link" href="#fifth_question">
                                                    fifth_question
                                                </a>
                                            </li>
                                        </ul>
                                        <div class="tab-content">
                                            ...
                                            <div id="full_name" class="tab-pane" role="tabpanel" style="text-align: center;">
                                                <p class="neon-text neon_planetdisplay inline-block">
                                                   Your Full Name
                                                </p>
                                                </br></br>
                                                <div class="form-check">
                                                <input name="full_name" class="input-form-modal form-control form-control-lg input--style-1 transparent-input neon-text-danger input-name" type="text" value="{{old('full_name')}}" autocomplete="off" placeholder="Full Name" maxlength="30" required>
                                            ...
                                            <div id="step-11" class="tab-pane" role="tabpanel" style="text-align: center;">
                                                <p class="neon-text neon_planetdisplay inline-block">
                                                    Image Uploading
                                                </p>
                                                </br></br>
                                                <div class="form-check">
                                                    ...
                                                    <button type="button" class="btn btn-success neon-text next-btn yes-btn" data-input=".us_citizen">Next</button>
                                                    <button class="btn btn-danger neon-text neon-text-danger no-btn next-btn" data-input=".us_citizen">Back</button>
